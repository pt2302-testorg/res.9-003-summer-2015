...
video_files:
  ...
  - file: /courses/res-9-003-brains-minds-and-machines-summer-course-summer-2015/1fb4b94498e208fedeb172a20e0b4d8c_eKKXJyabCAQ.pdf
    language: en
video_metadata:
  video_tags: color matching, complex cells simple cells., computation, inhomogenous
    stimuli, lienar filter, local gain control, local pooling, logic, metamers, noise,
    receptive field, rectifying nonlinearity, res-9-003-brains-minds-and-machines-summer-course-summer-2015,
    sensory perception, structural seeding, texture, tuned cells, ventral stream,
