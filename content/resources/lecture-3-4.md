...
video_files:
  ...
  - file: /courses/res-9-003-brains-minds-and-machines-summer-course-summer-2015/5e1396570761e8c0a80f1d3bd4295a34_zHa-n2M7Bj8.pdf
    language: en
video_metadata:
  video_tags: bayesian, classification, cognition, concepts, data, development, domain
    theories, generalizations, generative programming, knowledge, learning, machine
    learning, mnist, neural networks, omniglot, probabilistic programming, programming,
